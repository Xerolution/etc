 ...
 */
static const char * const BAR_FONT = "-*-lemon-*-*-*-*-*-*-*-*-*-*-*-*";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#f3f3f3";
static const char * const WIN_FS_COLOR = "#707070";
static const char * const SEL_COLOR    = "#95c1c0";
static const char * const BAR_BG_COLOR = "#f3f3f3";
static const char * const BAR_FG_COLOR = "#707070";
