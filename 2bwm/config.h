...
static const uint8_t offsets[] = {10,25,20,35};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
static const char *colors[] = {"#95c1c0","#f3f3f3","#9bbbe2","#94c138","#ff605a","#f3f3f3","#f3f3f3"};
/*
...
static const uint8_t borders[] = {2,3,15,4};
...
static key keys[] = {
    ...
    // Top right:
    {  MOD ,              XK_i,          teleport,          {.i=TWOBWM_TELEPORT_TOP_RIGHT}},
    // Bottom left:
...
//    {  MOD |SHIFT,        XK_m,          maxvert_hor,       {.i=TWOBWM_MAXIMIZE_HORIZONTALLY}},
    ...
    // vertically right
    {  MOD |SHIFT,        XK_i,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_RIGHT}},
    // horizontally left
...
/*    {  MOD |SHIFT|CONTROL,XK_u,          maxhalf,           {.i=TWOBWM_MAXHALF_FOLD_VERTICAL}},
    //fold half horizontally
*    {  MOD |SHIFT|CONTROL,XK_b,          maxhalf,           {.i=TWOBWM_MAXHALF_FOLD_HORIZONTAL}},
    //unfold vertically
*    {  MOD |SHIFT|CONTROL,XK_i,          maxhalf,           {.i=TWOBWM_MAXHALF_UNFOLD_VERTICAL}},
    //unfold horizontally
